...
desc 'Generate documentation for the it_store extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ItStoreExtension'
...
desc 'Test the it_store extension.'
...
namespace :test do
  desc 'Functional test the it_store extension.'
  ...
  desc 'Unit test the it_store extension.'
